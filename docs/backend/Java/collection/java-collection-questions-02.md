...
![TreeMap 继承关系图](https://img2.imgtp.com/2024/05/27/HP6cn4bK.png)
...
![jdk1.8 之前的内部结构-HashMap](https://img2.imgtp.com/2024/05/27/5BLq1UQt.png)

#### JDK1.8 之后

相比于之前的版本， JDK1.8 之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为 8）（将链表转换成红黑树前会判断，如果当前数组的长度小于 64，那么会选择先进行数组扩容，而不是转换为红黑树）时，将链表转化为红黑树，以减少搜索时间。

![jdk1.8之后的内部结构-HashMap](https://img2.imgtp.com/2024/05/27/UZj087nz.png)
...
![Hashtable 的内部结构](https://img2.imgtp.com/2024/05/27/5BLq1UQt.png)

<p style="text-align:right;font-size:13px;color:gray">https://www.cnblogs.com/chengxiao/p/6842045.html></p>

**JDK1.7 的 ConcurrentHashMap**：

![Java7 ConcurrentHashMap 存储结构](https://img2.imgtp.com/2024/05/27/i60mv0F7.png)
...
![Java8 ConcurrentHashMap 存储结构](https://img2.imgtp.com/2024/05/27/lm9t2Rb9.png)
